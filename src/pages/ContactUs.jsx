...
const ContactUs = () => {
  return (
    <>
      <div className="px-[12%] max-sm:px-2 py-20 flex max-sm:flex-col max-sm:items-center    gap-x-5">
        <div className="S flex- max-sm:mx-auto">
  ...
  return (
    <>
      <div className="flex-1">
        <div></div>
        <p className=" py-3 text-2xl max-sm:text-lg font-semibold text-neutral-600">
